...
export default class CardInputFormModal extends React.Component {
constructor(props) {
  super(props);
  this.state = {
    sport: '',
...
render() {
  ...
  return (
    <div className={showHideClassname}>
      <form className='card-input-form' type='button' onSubmit={this.props.handleSubmit(values => this.onSubmit(values))}>
